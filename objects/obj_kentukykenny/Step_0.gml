...
idlespr = spr_coolpinea;
stunfallspr = spr_coolpineahitbox;
walkspr = spr_coolpinea_idle;
stunspr = spr_coolpineahitbox;
grabbedspr = spr_coolpineahitbox;
...
if (x != obj_player.x && (state != baddiestates.throwing && (bombreset == 0 && grounded)))
{
