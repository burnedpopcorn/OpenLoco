with (obj_player1)
{
    if ((place_meeting(x + hsp, y, other.id) || place_meeting(x + xscale, y, other.id)) && (obj_player1.state == states.mach3 || obj_player1.state == UnknownEnum.Value_18))
...
with (obj_player2)
{
    if ((place_meeting(x + hsp, y, other.id) || place_meeting(x + xscale, y, other.id)) && (obj_player2.state == states.mach3 || obj_player2.state == UnknownEnum.Value_18))
        instance_destroy(other.id);
