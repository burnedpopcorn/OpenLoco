with (obj_player2)
{
    if (state == states.handstandjump && (other.hurted == 0 && (other.state != states.hurt && (other.state != states.knightpepslopes && (other.state != states.knightpep && (other.state != states.tumble && (other.state != 6 && (other.state != states.bombpep && (other.cutscene == 0 && (other.hurted == 0 && hurted == 0))))))))))
    {
