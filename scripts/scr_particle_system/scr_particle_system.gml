function create_debris(argument0, argument1, argument2, argument3 = 0, argument4 = 0, argument5 = 0)
{
    var q = 
    {
        x: argument0,
...
{
    global.part_map[? argument0] = part_type_create();
    global.part_depth[? argument0] = argument3;
    var p = global.part_map[? argument0];
...
{
    part_type_scale(global.part_map[? argument0], argument1, argument2);
    exit;
}
...
function create_collect_color(argument0, argument1, argument2, argument3, argument4, argument5 = 0)
{
    argument0 -= camera_get_view_x(view_camera[0]);
    argument1 -= camera_get_view_y(view_camera[0]);
    q = 
    {
        ...
        image_index: 0,
        image_number: sprite_get_number(argument2),
        colorpalettesprite: argument3,
        colorpalette: argument4,
        hsp: 0,
        vsp: 0,
        val: argument5
    };
...
function create_particle(argument0, argument1, argument2, argument3 = 0)
{
    ...
    var _depth = global.part_depth[? argument2];
    ...
    part_emitter_burst(global.particle_system, global.part_emitter, global.part_map[? argument2], 1);
    exit;
}
