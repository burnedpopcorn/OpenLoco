function scr_player_chainsawpogo()
{
    ...
    if (!key_down)
    {
        ...
        sprite_index = get_charactersprite("spr_chainsawair");
        state = states.chainsaw;
    }
    
    if (sprite_index != get_charactersprite("spr_chainsawpogobounce"))
    {
        if (sprite_index == get_charactersprite("spr_chainsawpogo1") && floor(image_index) == 3)
